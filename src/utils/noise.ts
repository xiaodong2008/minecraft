// Seeded PRNG, hashes and simplex noise (2D/3D) — no external dependencies.
...
/** Deterministic hash of integer coordinates -> [0, 1). Used for feature placement. */
...
export class Simplex2 {
  ...
  constructor(seed: number) { this.perm = buildPerm(seed); }
